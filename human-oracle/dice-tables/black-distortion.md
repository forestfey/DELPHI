# Black Die — Distorted Energy (Tamas / Distortion)

The Black die reflects obstacles, distorted perceptions, and shadow patterns. Spins amplify challenges or provide clues for deeper exploration.

## Base Meanings (without spin)

| Roll | Element | Core Quality |
|------|---------|-------------|
| 1 | Fire (red) | Indiscriminate possessiveness, obsessiveness, compulsion, consumerism |
| 2 | Air (green) | Envy, suspicion, jealousy, paranoia |
| 3 | Earth (yellow) | Obduracy, arrogance, pride, fixity, wilfulness, poverty/miserliness |
| 4 | Water (blue) | Anger, aggression, hatred, violence |
| 5 | Vortex (purple) | Destruction, fragmentation, disorder, disintegration |
| 6 | Star (gold) | Hubris, megalomania, obsessive expansion, overconfidence |
...
- **Up ↑**: The distortion projects outward — externalizing shadow material, potentially creating friction with others
- **Down ↓**: The distortion turns inward — confronting, containing, and potentially transforming the shadow pattern
